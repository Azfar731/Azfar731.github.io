...
export default function SocialLinks(){
    ...
    const arr= [{name:"Instagram",link:"https://www.instagram.com/"},{name:"Linkedin",link:"linkedin.com"},{name:"Github",link:"github.com"}]

    const elem = arr.map((site,index)=>{
        return (
            <div key={site.link} className={` linkContainer ${index < arr.length-1? 'rightBorder':''}`}>
